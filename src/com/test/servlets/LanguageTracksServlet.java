...
@WebServlet("/LanguageTracks")
public class LanguageTracksServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
   
    public LanguageTracksServlet() {
        super();
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//System.out.println("The language  = "+ lang);
		
		Connection connection = (Connection)getServletContext().getAttribute("dbconnection");
		ApplicationDao dao =new ApplicationDao();
		List<Tracks> tracklist= dao.getTracksByLanguage(lang,connection);
